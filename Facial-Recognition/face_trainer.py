...
# CascadeClassifier : detect objects in other images
cascade = cv2.CascadeClassifier("D:/four_one/esd_lab/Facial-Recognition/haarcascade_frontalface_default.xml")
...
def getdata():
    ...
    with open("D:/four_one/esd_lab/Facial-Recognition/labels.pickle", 'wb') as f:
...
recognise.save("D:/four_one/esd_lab/Facial-Recognition/trainner.yml")
